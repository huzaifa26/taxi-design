export default function Main(props){
    return(
        <div className="mainBackground w-[calc(100vw - 100%)] xsm:bg-none sm:bg-none">
            ...
            <div className="h-[calc(100%-80px)] flex xsm:flex-col sm:flex-col items-center xsm:gap-[20px] sm:gap-[20px] gap-[101px] xsm:bg-white sm:bg-white">
                ...
                <div className="w-[346px]">
                    ...
                    <div className="w-[316.71px] m-auto">
                        ...
                        <div className="flex mt-[19px] gap-[11px]">
                        ...
                        <button className="mt-[25px] m-auto flex items-center justify-center gap-[13px] w-[180px] h-[39px] bg-[#FF9F43] rounded-[10px] text-[14px] font-[400] leading-[21px] text-[#FFFFFF]"><img src="./images/mainSearch.png"/>Choose Vehicle</button>
                    </div>
                </div>
            </div>
        </div>
